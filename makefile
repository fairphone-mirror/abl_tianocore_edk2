...
ABL_FV_IMG: EDK_TOOLS_BIN
	...
	-D MINI_BUILD_VARIANT=$(MINI_BUILD_VARIANT) \
	...
	-D BOOTLOADER_VERSION=$(BOOTLOADER_VERSION) \
	-D BASED_VERSION=$(BASED_VERSION) \
	-D BUILD_ABL_WITH_RELEASEKEY=$(BUILD_ABL_WITH_RELEASEKEY) \
	-D INIT_BIN=$(INIT_BIN) \
