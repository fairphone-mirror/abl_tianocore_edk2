...
ifeq ($(TARGET_BUILD_MMITEST),true)
	MINI_BUILD_VARIANT := MINI_BUILD_VARIANT=1
else
	MINI_BUILD_VARIANT := MINI_BUILD_VARIANT=0
endif
#- FP5-279. lock device at first download MINI releases. liquan.zhou.t2m. 20230212
...
ifeq ($(BUILD_WITH_RELEASEKEY), true)
        BUILD_ABL_WITH_RELEASEKEY := BUILD_ABL_WITH_RELEASEKEY=1
else
        BUILD_ABL_WITH_RELEASEKEY := BUILD_ABL_WITH_RELEASEKEY=0
endif
